...
public class WrappedMerchantRecipeListv1_9_R2 implements WrappedMerchantRecipeList {
	
	private MerchantRecipeList merchantRecipeList;
	
	public WrappedMerchantRecipeListv1_9_R2(boolean newEmpty) {
		setHandle(newEmpty);
	}
	
	public WrappedMerchantRecipeListv1_9_R2(MerchantRecipeList merchantRecipeList) {
		this.merchantRecipeList = merchantRecipeList;
	}
	
	@Override
	public WrappedMerchantRecipeListv1_9_R2 setHandle(Object obj) {
	...
	public List<WrappedMerchantRecipe> getRecipes() {
		...
		for(MerchantRecipe merchantRecipe : merchantRecipeList) {
			list.add(new WrappedMerchantRecipev1_9_R2(merchantRecipe));
		}
		return list;
	}
	...
	public void setRecipes(List<WrappedMerchantRecipe> recipes) {
		...
		recipes.forEach(r -> merchantRecipeList.add(((WrappedMerchantRecipev1_9_R2)r).getHandle()));
	}
