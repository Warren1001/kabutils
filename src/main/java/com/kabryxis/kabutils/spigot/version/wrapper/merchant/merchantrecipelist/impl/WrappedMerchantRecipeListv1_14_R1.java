...
import com.kabryxis.kabutils.spigot.version.wrapper.merchant.merchantrecipe.impl.WrappedMerchantRecipev1_14_R1;
...
public class WrappedMerchantRecipeListv1_14_R1 implements WrappedMerchantRecipeList {
	
	private MerchantRecipeList merchantRecipeList;
	
	public WrappedMerchantRecipeListv1_14_R1(boolean newEmpty) {
		setHandle(newEmpty);
	}
	
	public WrappedMerchantRecipeListv1_14_R1(MerchantRecipeList merchantRecipeList) {
		this.merchantRecipeList = merchantRecipeList;
	}
	
	@Override
	public WrappedMerchantRecipeListv1_14_R1 setHandle(Object obj) {
	...
	public List<WrappedMerchantRecipe> getRecipes() {
		return merchantRecipeList.stream().map(WrappedMerchantRecipev1_14_R1::new).collect(Collectors.toList());
	}
	
	@Override
	public void setRecipes(List<WrappedMerchantRecipe> recipes) {
		merchantRecipeList.clear();
		recipes.forEach(r -> merchantRecipeList.add(((WrappedMerchantRecipev1_14_R1)r).getHandle()));
	}
