...
public class WrappedNBTTagCompoundv1_8_R2 extends WrappedNBTBasev1_8_R2 implements WrappedNBTTagCompound {
	...
	public void set(String key, Object obj) {
		...
		else if(obj instanceof WrappedNBTBasev1_8_R2) tag.set(key, ((WrappedNBTBasev1_8_R2)obj).getHandle());
	...
	@Override
	public WrappedNBTTagCompoundv1_8_R2 getCompound(String key, WrappedNBTTagCompound wrappedTag) {
		return ((WrappedNBTTagCompoundv1_8_R2)wrappedTag).setHandle(tag.getCompound(key));
	}
	
	@Override
	public WrappedNBTTagCompoundv1_8_R2 getCompound(String key) {
		return getCompound(key, new WrappedNBTTagCompoundv1_8_R2());
	}
	
	@Override
	public WrappedNBTTagListv1_8_R2 getList(String key, int i, WrappedNBTTagList list) {
		return ((WrappedNBTTagListv1_8_R2)list).setHandle(tag.getList(key, i));
	}
