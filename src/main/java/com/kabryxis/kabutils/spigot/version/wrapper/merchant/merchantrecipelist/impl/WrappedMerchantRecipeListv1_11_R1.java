...
public class WrappedMerchantRecipeListv1_11_R1 implements WrappedMerchantRecipeList {
	
	private MerchantRecipeList merchantRecipeList;
	
	public WrappedMerchantRecipeListv1_11_R1(boolean newEmpty) {
		setHandle(newEmpty);
	}
	
	public WrappedMerchantRecipeListv1_11_R1(MerchantRecipeList merchantRecipeList) {
		this.merchantRecipeList = merchantRecipeList;
	}
	
	@Override
	public WrappedMerchantRecipeListv1_11_R1 setHandle(Object obj) {
	...
	public List<WrappedMerchantRecipe> getRecipes() {
		...
		for(MerchantRecipe merchantRecipe : merchantRecipeList) {
			list.add(new WrappedMerchantRecipev1_11_R1(merchantRecipe));
		}
		return list;
	}
	...
	public void setRecipes(List<WrappedMerchantRecipe> recipes) {
		...
		recipes.forEach(r -> merchantRecipeList.add(((WrappedMerchantRecipev1_11_R1)r).getHandle()));
	}
