...
public class WrappedNBTTagCompoundv1_10_R1 extends WrappedNBTBasev1_10_R1 implements WrappedNBTTagCompound {
	...
	public WrappedNBTTagCompoundv1_10_R1(Object obj) {
		setHandle(obj);
	}
	
	@Override
	public WrappedNBTTagCompoundv1_10_R1 setHandle(Object obj) {
	...
	@Override
	public WrappedNBTTagCompoundv1_10_R1 getCompound(String key, WrappedNBTTagCompound wrappedTag) {
		return ((WrappedNBTTagCompoundv1_10_R1)wrappedTag).setHandle(tag.getCompound(key));
	}
	
	@Override
	public WrappedNBTTagCompoundv1_10_R1 getCompound(String key) {
		return getCompound(key, new WrappedNBTTagCompoundv1_10_R1());
	}
	
	@Override
	public WrappedNBTTagListv1_10_R1 getList(String key, int i, WrappedNBTTagList list) {
		return ((WrappedNBTTagListv1_10_R1)list).setHandle(tag.getList(key, i));
	}
