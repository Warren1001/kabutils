...
public class WrappedEntityVillagerv1_11_R1 implements WrappedEntityVillager {
	
	private EntityVillager entityVillager;
	
	public WrappedEntityVillagerv1_11_R1(Villager villager) {
		setHandle(villager);
	}
	
	@Override
	public WrappedEntityVillagerv1_11_R1 setHandle(Object obj) {
	...
	public WrappedMerchantRecipeListv1_11_R1 getOffers() {
		return new WrappedMerchantRecipeListv1_11_R1(entityVillager.getOffers(null));
	}
