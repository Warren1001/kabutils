...
public class WrappedNBTBasev1_11_R1 implements WrappedNBTBase {
	
	private NBTBase handle;
	
	public WrappedNBTBasev1_11_R1() {}
	
	public WrappedNBTBasev1_11_R1(NBTBase base) {
		this.handle = base;
	}
	
	@Override
	public WrappedNBTBasev1_11_R1 setHandle(Object obj) {
