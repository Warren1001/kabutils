...
public class WrappedMerchantRecipeListv1_12_R1 implements WrappedMerchantRecipeList {
	...
	@Override
	public WrappedMerchantRecipeListv1_12_R1 setHandle(Object obj) {
	...
	public List<WrappedMerchantRecipe> getRecipes() {
		...
		for(MerchantRecipe merchantRecipe : merchantRecipeList) {
			list.add(new WrappedMerchantRecipev1_12_R1(merchantRecipe));
		}
		return list;
	}
	...
	public void setRecipes(List<WrappedMerchantRecipe> recipes) {
		...
		recipes.forEach(r -> merchantRecipeList.add(((WrappedMerchantRecipev1_12_R1)r).getHandle()));
	}
