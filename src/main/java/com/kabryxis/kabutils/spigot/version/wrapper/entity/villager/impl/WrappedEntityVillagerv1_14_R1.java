...
import com.kabryxis.kabutils.spigot.version.wrapper.merchant.merchantrecipelist.impl.WrappedMerchantRecipeListv1_14_R1;
import net.minecraft.server.v1_14_R1.EntityVillager;
import org.bukkit.craftbukkit.v1_14_R1.entity.CraftVillager;
import org.bukkit.entity.Villager;

public class WrappedEntityVillagerv1_14_R1 implements WrappedEntityVillager {
	
	private EntityVillager entityVillager;
	
	public WrappedEntityVillagerv1_14_R1(Villager villager) {
		setHandle(villager);
	}
	
	@Override
	public WrappedEntityVillagerv1_14_R1 setHandle(Object obj) {
	...
	@Override
	public WrappedMerchantRecipeListv1_14_R1 getOffers() {
		return new WrappedMerchantRecipeListv1_14_R1(entityVillager.getOffers());
	}
