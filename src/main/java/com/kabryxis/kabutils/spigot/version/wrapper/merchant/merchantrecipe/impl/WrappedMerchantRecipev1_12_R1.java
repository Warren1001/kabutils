...
public class WrappedMerchantRecipev1_12_R1 implements WrappedMerchantRecipe {
	
	private MerchantRecipe merchantRecipe;
	
	public WrappedMerchantRecipev1_12_R1(ItemStack buyItem1, ItemStack sellingItem, int uses, int maxUses) {
		this(buyItem1, null, sellingItem, uses, maxUses);
	}
	
	public WrappedMerchantRecipev1_12_R1(ItemStack buyItem1, ItemStack buyItem2, ItemStack sellingItem, int uses, int maxUses) {
		this(new MerchantRecipe(buyItem1, buyItem2, sellingItem, uses, maxUses));
	}
	
	public WrappedMerchantRecipev1_12_R1(MerchantRecipe merchantRecipe) {
		this.merchantRecipe = merchantRecipe;
	}
	
	@Override
	public WrappedMerchantRecipev1_12_R1 setHandle(Object obj) {
