...
public class WrappedMerchantRecipeListv1_10_R1 implements WrappedMerchantRecipeList {
	
	private MerchantRecipeList merchantRecipeList;
	
	public WrappedMerchantRecipeListv1_10_R1(boolean newEmpty) {
		setHandle(newEmpty);
	}
	...
	@Override
	public WrappedMerchantRecipeListv1_10_R1 setHandle(Object obj) {
