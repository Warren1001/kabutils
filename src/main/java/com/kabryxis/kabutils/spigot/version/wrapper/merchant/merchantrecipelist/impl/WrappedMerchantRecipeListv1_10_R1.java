...
public class WrappedMerchantRecipeListv1_10_R1 extends WrappedMerchantRecipeList<MerchantRecipeList> {
	...
	public List<WrappedMerchantRecipe<?>> getRecipes() {
		...
		for(Object obj : rList) {
			...
			WrappedMerchantRecipev1_10_R1 handle = (WrappedMerchantRecipev1_10_R1)WrappableCache.get(WrappedMerchantRecipe.class);
			handle.set(recipe);
			list.add(handle);
		}
		return list;
	...
	public void setRecipes(List<WrappedMerchantRecipe<?>> recipes) {
		...
		list.clear();
		recipes.forEach(r -> list.add(((WrappedMerchantRecipev1_10_R1)r).get()));
	}
