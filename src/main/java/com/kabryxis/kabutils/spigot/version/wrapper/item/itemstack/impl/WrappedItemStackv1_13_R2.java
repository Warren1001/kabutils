...
public class WrappedItemStackv1_13_R2 implements WrappedItemStack {
	
	private ItemStack itemStack;
	private boolean clone = false;
	
	public WrappedItemStackv1_13_R2(Object obj) {
		setHandle(obj);
	}
	
	@Override
	public WrappedItemStackv1_13_R2 setHandle(Object obj) {
		...
		else if(obj instanceof WrappedNBTTagCompoundv1_13_R2) {
			clone = true;
			this.itemStack = ItemStack.a(((WrappedNBTTagCompoundv1_13_R2)obj).getHandle());
		}
		return this;
	}
	...
	@Override
	public WrappedNBTTagCompoundv1_13_R2 getTag(boolean create) {
		...
		return new WrappedNBTTagCompoundv1_13_R2(tag);
	}
	
	@Override
	public void save(WrappedNBTTagCompound tag) {
		itemStack.save(((WrappedNBTTagCompoundv1_13_R2)tag).getHandle());
	}
