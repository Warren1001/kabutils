...
public class WrappedEntityVillagerv1_13_R2 implements WrappedEntityVillager {
	
	private EntityVillager entityVillager;
	
	public WrappedEntityVillagerv1_13_R2(Villager villager) {
		setHandle(villager);
	}
	
	@Override
	public WrappedEntityVillagerv1_13_R2 setHandle(Object obj) {
	...
	@Override
	public WrappedMerchantRecipeListv1_13_R2 getOffers() {
		return new WrappedMerchantRecipeListv1_13_R2(entityVillager.getOffers(null));
	}
