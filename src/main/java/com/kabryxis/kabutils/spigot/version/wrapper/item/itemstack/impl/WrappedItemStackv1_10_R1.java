...
public class WrappedItemStackv1_10_R1 implements WrappedItemStack {
	
	private ItemStack itemStack;
	private boolean clone = false;
	
	public WrappedItemStackv1_10_R1(Object obj) {
		setHandle(obj);
	}
	
	@Override
	public WrappedItemStackv1_10_R1 setHandle(Object obj) {
		...
		else if(obj instanceof WrappedNBTTagCompoundv1_10_R1) {
			clone = true;
			this.itemStack = ItemStack.createStack(((WrappedNBTTagCompoundv1_10_R1)obj).getHandle());
		}
		return this;
	}
	...
	@Override
	public WrappedNBTTagCompoundv1_10_R1 getTag(boolean create) {
		...
		return new WrappedNBTTagCompoundv1_10_R1(tag);
	}
