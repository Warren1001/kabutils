...
public class WrappedMerchantRecipev1_9_R1 implements WrappedMerchantRecipe {
	...
	public WrappedMerchantRecipev1_9_R1(ItemStack buyItem1, ItemStack sellingItem, int uses, int maxUses) {
		this(buyItem1, null, sellingItem, uses, maxUses);
	}
	
	public WrappedMerchantRecipev1_9_R1(ItemStack buyItem1, ItemStack buyItem2, ItemStack sellingItem, int uses, int maxUses) {
	...
	@Override
	public WrappedMerchantRecipev1_9_R1 setHandle(Object obj) {
