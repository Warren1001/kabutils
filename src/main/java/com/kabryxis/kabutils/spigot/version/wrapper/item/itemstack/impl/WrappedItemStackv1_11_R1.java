...
public class WrappedItemStackv1_11_R1 extends WrappedItemStack {
	
	private final ItemStack itemStack;
	
	public WrappedItemStackv1_11_R1(org.bukkit.inventory.ItemStack itemStack) {
		this.itemStack = CraftItemStack.asNMSCopy(itemStack);
	}
	
	public WrappedItemStackv1_11_R1(WrappedNBTTagCompound tag) {
		this.itemStack = new ItemStack(((WrappedNBTTagCompoundv1_11_R1)tag).getHandle());
	}
