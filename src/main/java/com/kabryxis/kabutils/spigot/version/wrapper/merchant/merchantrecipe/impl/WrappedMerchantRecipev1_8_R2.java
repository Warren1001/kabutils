...
public class WrappedMerchantRecipev1_8_R2 implements WrappedMerchantRecipe {
	
	private MerchantRecipe merchantRecipe;
	
	public WrappedMerchantRecipev1_8_R2(ItemStack buyItem1, ItemStack sellingItem, int uses, int maxUses) {
		this(buyItem1, null, sellingItem, uses, maxUses);
	}
	
	public WrappedMerchantRecipev1_8_R2(ItemStack buyItem1, ItemStack buyItem2, ItemStack sellingItem, int uses, int maxUses) {
		this(new MerchantRecipe(buyItem1, buyItem2, sellingItem, uses, maxUses));
	}
	
	public WrappedMerchantRecipev1_8_R2(MerchantRecipe merchantRecipe) {
		this.merchantRecipe = merchantRecipe;
	}
	
	@Override
	public WrappedMerchantRecipev1_8_R2 setHandle(Object obj) {
