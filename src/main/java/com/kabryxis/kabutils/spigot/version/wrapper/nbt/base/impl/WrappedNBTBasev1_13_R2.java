...
public class WrappedNBTBasev1_13_R2 implements WrappedNBTBase {
	
	private NBTBase handle;
	
	public WrappedNBTBasev1_13_R2() {}
	
	public WrappedNBTBasev1_13_R2(NBTBase base) {
		this.handle = base;
	}
	
	@Override
	public WrappedNBTBasev1_13_R2 setHandle(Object obj) {
