...
public class WrappedItemStackv1_8_R1 extends WrappedItemStack {
	
	private final ItemStack itemStack;
	
	public WrappedItemStackv1_8_R1(org.bukkit.inventory.ItemStack itemStack) {
		this.itemStack = CraftItemStack.asNMSCopy(itemStack);
	}
	
	public WrappedItemStackv1_8_R1(WrappedNBTTagCompound tag) {
		this.itemStack = ItemStack.createStack(((WrappedNBTTagCompoundv1_8_R1)tag).getHandle());
	}
