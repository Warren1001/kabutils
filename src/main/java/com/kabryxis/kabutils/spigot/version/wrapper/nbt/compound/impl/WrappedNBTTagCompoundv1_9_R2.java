...
import com.kabryxis.kabutils.spigot.version.wrapper.nbt.base.impl.WrappedNBTBasev1_9_R2;
...
public class WrappedNBTTagCompoundv1_9_R2 extends WrappedNBTBasev1_9_R2 implements WrappedNBTTagCompound {
	...
	public WrappedNBTTagCompoundv1_9_R2(Object obj) {
		setHandle(obj);
	}
	
	@Override
	public WrappedNBTTagCompoundv1_9_R2 setHandle(Object obj) {
	...
	public void set(String key, Object obj) {
		...
		else if(obj instanceof WrappedNBTBasev1_9_R2) tag.set(key, ((WrappedNBTBasev1_9_R2)obj).getHandle());
	...
	@Override
	public WrappedNBTTagCompoundv1_9_R2 getCompound(String key, WrappedNBTTagCompound wrappedTag) {
		return ((WrappedNBTTagCompoundv1_9_R2)wrappedTag).setHandle(tag.getCompound(key));
	}
	
	@Override
	public WrappedNBTTagCompoundv1_9_R2 getCompound(String key) {
		return getCompound(key, new WrappedNBTTagCompoundv1_9_R2());
	}
	
	@Override
	public WrappedNBTTagListv1_9_R2 getList(String key, int i, WrappedNBTTagList list) {
		return ((WrappedNBTTagListv1_9_R2)list).setHandle(tag.getList(key, i));
	}
