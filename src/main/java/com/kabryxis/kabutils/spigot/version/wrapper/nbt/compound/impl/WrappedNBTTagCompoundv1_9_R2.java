...
public class WrappedNBTTagCompoundv1_9_R2 extends WrappedNBTTagCompound<NBTTagCompound> {
	...
	public void set(String key, WrappedNBTTagList<?> list) {
		get().set(key, ((WrappedNBTTagListv1_9_R2)list).get());
	}
	
	@Override
	public void getList(WrappedNBTTagList<?> instance, String key, int i) {
		WrappedNBTTagListv1_9_R2 handle = (WrappedNBTTagListv1_9_R2)instance;
