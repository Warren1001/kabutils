...
public class WrappedItemStackv1_8_R2 extends WrappedItemStack {
	
	private final ItemStack itemStack;
	
	public WrappedItemStackv1_8_R2(org.bukkit.inventory.ItemStack itemStack) {
		this.itemStack = CraftItemStack.asNMSCopy(itemStack);
	}
	
	public WrappedItemStackv1_8_R2(WrappedNBTTagCompound tag) {
		this.itemStack = ItemStack.createStack(((WrappedNBTTagCompoundv1_8_R2)tag).getHandle());
	}
