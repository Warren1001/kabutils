...
import com.kabryxis.kabutils.spigot.version.wrapper.nbt.list.impl.WrappedNBTTagListv1_15_R1;
...
public class WrappedNBTTagCompoundv1_15_R1 extends WrappedNBTBasev1_15_R1 implements WrappedNBTTagCompound {
	
	private NBTTagCompound tag;
	
	public WrappedNBTTagCompoundv1_15_R1() {
		tag = null;
	}
	
	public WrappedNBTTagCompoundv1_15_R1(Object obj) {
		setHandle(obj);
	}
	
	@Override
	public WrappedNBTTagCompoundv1_15_R1 setHandle(Object obj) {
	...
	public void set(String key, Object obj) {
		...
		else if(obj instanceof WrappedNBTBasev1_15_R1) tag.set(key, ((WrappedNBTBasev1_15_R1)obj).getHandle());
	...
	@Override
	public WrappedNBTTagCompoundv1_15_R1 getCompound(String key, WrappedNBTTagCompound wrappedTag) {
		return ((WrappedNBTTagCompoundv1_15_R1)wrappedTag).setHandle(tag.getCompound(key));
	}
	
	@Override
	public WrappedNBTTagCompoundv1_15_R1 getCompound(String key) {
		return getCompound(key, new WrappedNBTTagCompoundv1_15_R1());
	}
	
	@Override
	public WrappedNBTTagListv1_15_R1 getList(String key, int i, WrappedNBTTagList list) {
		return ((WrappedNBTTagListv1_15_R1)list).setHandle(tag.getList(key, i));
	}
	
	@Override
	public WrappedNBTTagListv1_15_R1 getList(String key, int i) {
		return new WrappedNBTTagListv1_15_R1(tag.getList(key, i));
	}
