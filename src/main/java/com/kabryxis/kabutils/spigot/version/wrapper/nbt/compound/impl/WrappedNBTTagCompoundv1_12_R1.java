...
public class WrappedNBTTagCompoundv1_12_R1 extends WrappedNBTTagCompound {
	...
	public WrappedNBTTagCompoundv1_12_R1(NBTTagCompound tag) {
		this.tag = tag;
	}
	
	public WrappedNBTTagCompoundv1_12_R1(File playerFile) {
	...
	public void set(String key, WrappedNBTTagList list) {
		tag.set(key, ((WrappedNBTTagListv1_12_R1)list).getHandle());
	}
