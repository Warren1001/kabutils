...
public class WrappedNBTTagCompoundv1_12_R1 extends WrappedNBTTagCompound<NBTTagCompound> {
	...
	public void set(String key, WrappedNBTTagList<?> list) {
		get().set(key, ((WrappedNBTTagListv1_12_R1)list).get());
	}
	
	@Override
	public void getList(WrappedNBTTagList<?> instance, String key, int i) {
		WrappedNBTTagListv1_12_R1 handle = (WrappedNBTTagListv1_12_R1)instance;
